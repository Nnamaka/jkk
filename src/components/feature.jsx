...
const Feature = () => {
    return ( 
        ...
        <div className="md:flex flex-cols mx-6 my-auto md:space-y-0 ">
            ...
            {/* First Feature */}
            <div className="flex-col items-center md-[768px]:mr-4 ">
                ...
                <p className="h-40 pt-4 font-sans text-2xl  text-left">Dive into a world of instant musical enjoyment 
            ...
            <div className="flex-col items-center md-[768px]:mr-4 ">
                ...
                <p className="h-40 pt-4 font-sans text-2xl  text-left">Discover personalized music suggestions tailored 
            ...
            <div className="flex-col items-center md-[768px]:mr-4 ">
                ...
                <p className="h-40 pt-4 font-sans text-2xl text-left ">Experience premium music features without paying 
